...
func MakeAssignmentsFetcherHandler(s service.VerificationService) http.Handler {
...
func MakeAssignmentFetcherHandler(s service.VerificationService) http.Handler {
	return kithttp.NewServer(
